    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
              'attribute' => 'position',
              'value' => 'position.name',
              'filter'=> ArrayHelper::map(Positions::find()->asArray()->all(), 'name', 'name'),
            ],
            [
              'attribute' => 'unit',
              'value' => 'unit.name',
            ...
            [
                ...
                'header' => '<div class="text-center"><a href="/'. Yii::$app->controller->module->id . '/vacancies/create" class="btn btn-outline-info btn-rounded"}\'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
